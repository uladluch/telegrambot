...
`/location город` — сменить место (геокодинг open-meteo). По умолчанию Warsaw,
хранится в `bot_state.weather_loc`. В утренний дайджест погода добавляется интро-текстом.
